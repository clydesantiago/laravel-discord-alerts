...
You can set a `DISCORD_ALERT_WEBHOOK` env variable containing a valid Discord webhook URL. You can learn how to get a webhook URL [in the Discord API docs](https://api.discord.com/messaging/webhooks](https://discord.com/developers/docs/resources/webhook).
